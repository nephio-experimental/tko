...
// NewForConfig creates a new TkoV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new TkoV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TkoV1alpha1Client, error) {
	...
	return &TkoV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new TkoV1alpha1Client for the given config and
...
func New(c rest.Interface) *TkoV1alpha1Client {
	return &TkoV1alpha1Client{c}
}
